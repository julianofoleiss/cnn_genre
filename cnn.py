...
def build_cnn(input_var=None, input_rows=513, input_cols=800, input_channels=1, 
filter_size=(5,5), n_filters=32, dense_layer_neurons=256, out_units=10,
pool_size=(2,2)):
    # As a third model, we'll create a CNN of two convolution + pooling stages
    # and a fully-connected hidden layer in front of the output layer.

    # Input layer, as usual:
    network = lasagne.layers.InputLayer(shape=(None, input_channels, input_rows, input_cols),
                                        input_var=input_var)
...
def main(model='mlp', num_epochs=500, meta_file="meta_jgtzan100.txt"):
    ...
    if model == 'mlp':
        ...
        network = build_cnn(input_var, input_rows=100, input_cols=100)
    else:
